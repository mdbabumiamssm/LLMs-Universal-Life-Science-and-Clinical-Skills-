...
class LLMFactory:
    ...
    def register_defaults(cls) -> None:
        ...
        from platform.adapters.anthropic_adapter import AnthropicAdapter
        from platform.adapters.openai_runtime_adapter import OpenAIRuntimeAdapter
        from platform.adapters.gemini_adapter import GeminiAdapter
        from platform.adapters.local_adapter import LocalAdapter
