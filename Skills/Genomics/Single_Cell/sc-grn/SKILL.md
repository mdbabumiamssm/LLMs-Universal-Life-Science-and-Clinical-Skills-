...
---
name: bio-sc-grn
description: "Gene regulatory network inference using pySCENIC three-step pipeline\
  \ (GRNBoost2 \u2192 cisTarget \u2192 AUCell), with correlation-based fallback. Identifies\
  \ transcription factor regulons and scores their activity per cell."
tool_type: mixed
