...
---
name: bio-sc-preprocessing
description: Single-cell RNA-seq QC, normalization, HVG selection, PCA, UMAP, and
  Leiden clustering. Supports both Scanpy (Python) and Seurat (R) workflows.
tool_type: mixed
