...
---
name: bio-sc-multiome
description: Multi-omics integration for single-cell data (CITE-seq, 10X Multiome,
  SHARE-seq). Weighted Nearest Neighbor (WNN) analysis, MOFA+, and muon/MuData workflows.
tool_type: mixed
