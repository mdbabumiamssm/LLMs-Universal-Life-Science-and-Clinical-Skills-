...
---
name: bio-sc-doublet-detection
description: Doublet detection and removal using Scrublet (Python), DoubletFinder
  (R), and scDblFinder (R). Essential QC step before clustering.
tool_type: mixed
