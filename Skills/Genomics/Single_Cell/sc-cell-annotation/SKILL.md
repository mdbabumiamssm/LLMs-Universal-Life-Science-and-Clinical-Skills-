...
---
name: bio-sc-cell-annotation
description: Automated cell type annotation using marker genes, CellTypist, SingleR,
  or scmap. Supports custom references and marker gene lists.
tool_type: mixed
