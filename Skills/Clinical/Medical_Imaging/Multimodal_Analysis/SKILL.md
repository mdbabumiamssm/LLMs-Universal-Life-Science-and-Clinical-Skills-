...
4.  **Dermatology/Dermoscopy BCC Benchmarking**: For clinical or dermoscopic images involving suspected basal cell carcinoma and common mimickers, benchmark multimodal image-plus-clinical prompting across ChatGPT, Gemini, Claude, or other VLMs without reporting unsupported performance claims. Use modality-specific prompts that distinguish clinical close-up photography from dermoscopy, keep the supplied clinical context visible in the prompt, ask for a differential rather than a single label, report diagnostic uncertainty and image-quality limitations explicitly, and require dermatologist review before any clinical decision, patient-facing guidance, or benchmark interpretation.
