...
4.  **Dermatology/Dermoscopy BCC Benchmarking**: For clinical or dermoscopic images involving suspected basal cell carcinoma and common mimickers, apply image-quality gates before analysis (focus, lighting/color, lesion framing, scale/metadata, and dermoscopic artifact control) and defer interpretation when quality is inadequate. Compare ChatGPT, Gemini, Claude, or other multimodal models with consistent image-plus-clinical prompts and no unsupported performance claims. Use modality-specific prompts that distinguish clinical close-up photography from dermoscopy, keep the supplied clinical context visible, frame outputs as differential diagnoses rather than single labels, report diagnostic uncertainty and quality limitations explicitly, and require dermatologist review before any clinical decision, patient-facing guidance, or benchmark interpretation.
