...
4.  **Dermatology/Dermoscopy BCC Evaluation**: For clinical or dermoscopic images involving suspected basal cell carcinoma and common mimickers, apply image-quality gates before analysis (focus, lighting/color, lesion framing, scale/metadata, and dermoscopic artifact control) and defer interpretation when quality is inadequate. Score each differential diagnosis consistently rather than returning a single label; compare ChatGPT, Gemini, Claude, or other multimodal models with matched image-plus-clinical prompts and no unsupported performance claims; assess confidence calibration; and perform lesion-level error analysis by diagnosis, modality, image quality, and clinically relevant context. Report uncertainty, quality limitations, and model disagreements explicitly, and require dermatologist review before any clinical decision, patient-facing guidance, or benchmark interpretation.
